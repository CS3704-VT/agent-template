...
To use this template, you will need git, npm, and an ARC_API_KEY environment variable set to your API key from Virginia Tech's Advanced Research Computing: https://www.docs.arc.vt.edu/ai/011_llm_api_arc_vt_edu.html#llm-api-arc-vt-edu
