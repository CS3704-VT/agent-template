...
description: Facilitates deliberate skill development during AI-assisted coding. Offers interactive learning exercises after architectural work on assignments or projects (new files, schema changes, refactors). Use when completing features, making design decisions, or when user asks to understand code better. Supports the user's stated goal of understanding design choices as learning opportunities.
...
- "We used this pattern for validating the login form — how would you apply the same idea to validating the signup form?"
...
1. `.opencode/skills/learning-opportunities/resources/orientation.md` (Opencode project level)
...
The `orient` skill (`.opencode/skills/orient/`) generates this file — invoke `/orient` to (re)generate it.
