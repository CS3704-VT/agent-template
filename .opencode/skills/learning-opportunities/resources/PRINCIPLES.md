<!-- Based on the learning-opportunities skill principles by Dr. Cat Hicks (https://github.com/DrCatHicks/learning-opportunities), licensed under CC-BY-4.0. Adapted for the CS3704 (Intermediate Software Design and Engineering) course at Virginia Tech [Fall 2026] by Dr. Chris Brown. -->
...
Focusing on long-term learning outcomes, rather than short-term performance (e.g., grades on the assignment), helps learners.
...
**Risk in AI-assisted work:** Becoming a passive recipient of generated solutions. If a student only reads and accepts output or blindly accepts, they skip the generative processing that builds understanding.
...
**Risk in AI-assisted work:** Machine velocity and ease of AI generation can push a user into constant "cram"—completing work in singular large pushes rather than repeatedly returning to tasks with interruption. This risk compounds with assignment deadlines---for instance, a student who starts a project the night before it's due is already structurally pushed toward cramming practice, and AI-assisted velocity can make that single session feel more sufficient than it is.
...
**Risk in AI-assisted work:** Users often optimize for short-term performance (getting the assignment turned in, grades) at the expense of long-term capability, while underestimating the learning gain from productive struggle. 
